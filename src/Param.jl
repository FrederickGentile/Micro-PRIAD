...
#=====================================================================================================================#
#= ################################################################################################################# =#
#= #  This is the only file that the users should modify to create new PGinstance                                  # =#
#= #                                                                                                               # =#
#= #  Only variable in comment square like this one should be modify by users                                      # =#
#= #                                                                                                               # =#
#= #  The users can either choose to use a predefined PGinstance by initializing the "PGinstance" variable to an   # =#
...
=#
function nbParam(PGinstance::Int64)
#######################################################################################################################
#=====================================================================================================================#
#==#################################################################################################################==#
#==#                                                                                                               #==#
#================================= To fill by the user if PGinstance ∉ [1, 2, 3]======================================#
#==#                                                                                                               #==#
...
function MaintenancesParam(PGinstance::Int64)
######################################################################################################################################################################################################
#====================================================================================================================================================================================================#
#==################################################################################################################################################################################################==#
#==#                                                                                                                                                                                              #==#
...
function FailuresParam(PGinstance::Int64)
######################################################################################################################################################################################################
#====================================================================================================================================================================================================#
#==################################################################################################################################################################################################==#
#==#                                                                                                                                                                                              #==#
